...
<div class="head-title">
    <h1 class="text-center m-0 p-0">Facture Pro-forma</h1>
</div>
        ...
        <tr>
            <td>
                <div class="box-text">
                    ...
                    <strong>N° {{$data[0]->num_facture}} </strong>
                </div>
            </td>
            <td>
                <div class="box-text">
                   <span>Client : </span> <strong>{{$data[0]->client_facture}} </strong>
                </div>
            </td>
        </tr>
    </table>
            ...
            <td colspan="7">
                <div class="total-part">
                    <div class="total-left w-85 float-left" align="right">
                        <p>Sous Total</p>
                        <p>Remise ({{$data[0]->taux_remise}} %)</p>
                        <p>Total Payable</p>
                    </div>
                    <div class="total-right w-15 float-left text-bold" align="right">
                        <p>{{$data[0]->montant_facture}}</p>
                        <p>{{ (float)($data[0]->taux_remise /100) * (float)$data[0]->montant_facture }}</p>
                        <p>{{$data[0]->montant_total}}</p>
                    </div>
                    <div style="clear: both;"></div>
                </div>
            </td>
