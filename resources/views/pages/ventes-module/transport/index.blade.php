...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex">
        ...
        <div class="col-6 justify-content-end">
            ...
            <a href="{{ route('UniteBase') }}" class="btn btn-sm bg-dark text_orange float-end" style="margin-right: 1%"> Unité de base</a>
            <button type="button" class="btn btn-sm bg-light text-dark float-end mx-2" id="tauxBtn">
                Mettre Taux </button> --}}

            {{-- @can('articles.ajouter-article') --}}
            <a href="{{ route('transports.create') }}" style="margin-left: 10px;" class="btn btn-sm bg-dark text_orange float-end petit_bouton"> <i class="bi bi-plus-circle"></i> Ajouter une requête de transport</a>
            {{-- @endcan --}}
    ...
    <section class="section">
        <div class="row">
            <div class="col-lg-12 py-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title text-dark">Liste des requêtes de transport</h5>
                        <table id="example" class=" table table-bordered border-warning  table-hover table-sm">
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                <li>
                                                    <a href="{{route('transports.show', $transport->id)}}" data-bs-toggle="tooltip" class="dropdown-item" data-bs-placement="left" data-bs-title="Détail"><i class="bi bi-list"></i> Détail </a>
                                                </li>
                                                <li>
                                                    <a href="{{route('transports.edit', $transport->id)}}" data-bs-toggle="tooltip" class="dropdown-item" data-bs-placement="left" data-bs-title="Editer"><i class="bi bi-pencil"></i> Modifier </a>
                                                </li>
                                                <li>
                                                ...
                                                <li>
                                                    <form action="{{ route('transports.destroy', $transport->id) }}"
                                                        ...
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit" class="dropdown-item" data-bs-toggle="tooltip" data-bs-placement="left" data-bs-title="Supprimer la requête" onclick="return confirm('Voulez vous vraiment supprimer cette requête? Cette opération est irréversible')"><i class="bi bi-trash"></i> Supprimer</button>
                                                    </form>
                                                </li>
