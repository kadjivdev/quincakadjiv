...
<main id="main" class="main">
    ...
    <div class="pagetitle d-flex">
        <div class="col-4">
            ...
            <h1 class="float-left">{{ $bon_data->ref_bon }}</h1>
        </div>

        <div class="col-4">
            <small>Référence de la Vente</small>
                    ...
                    <div class="card-body py-1">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6 float-right">
                                ...
                                <a href="{{ route('bons-ventes.index') }}" class="btn btn-warning btn-sm float-end mt-2"> <i
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="dropdown">
                                            <button class="btn btn-sm bg-adrk text_orange dropdown-toggle" type="button"
                                            ...
                                            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                ...
                                                <li>
                                                    <form
                                                        action="{{ route('validation-liv-clt-vc', $livraison->id) }}"
                                                ...
                                                <li>
                                                    <a class="dropdown-item text-danger" style="cursor: pointer" data-bs-toggle="modal"
                                                        ...
                                                        <i class="bi bi-trash"></i> Rejeter </a>
                                                </li>

                                                <li>
                                                    <form action="{{ route('delete-liv-vc', $livraison->id) }}"
                                                        class="form-inline" method="POST"
                                                        ...
                                                        <button type="submit" class="dropdown-item text-danger"
                                                            data-bs-toggle="tooltip" data-bs-placement="left"
                                                            data-bs-title="Supprimer le bon "><i class="bi bi-trash"></i> Supprimer cette Livraison</button>
                                                    </form>
                                                </li>
                                        ...
                                        @if (!is_null($livraison->validated_at))
                                        <span class="badge rounded-pill text-bg-success"><i class="bi bi-check-circle"></i> Validée</span>
                                        @endif
                                    </td>
                                </tr>
                                ...
                                <div class="modal fade" id="staticBackdrop{{ $livraison->id }}" data-bs-keyboard="false" tabindex="-1"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <form action="{{ route('rejeter-liv-clt-vc', $livraison->id) }}"
                                                method="post">
