...
@section('content')
    <main id="main" class="main">
        <div class="pagetitle d-flex">
            <div class="col-6">
                <h1 class="float-left">Bons des ventes au comptant</h1>
            </div>
            <div class="col-6">
                                ...
                                <tbody>
                                    @forelse ($bon_liv_clt as $livraison)
                                        ...
                                        <tr>
                                            <td>{{ $livraison->id }} </td>
                                            <td>{{ $formattedDate }}</td>
                                            <td>{{ $livraison->ref_bon }}</td>
                                            <td>{{ $livraison->vente_reference }}</td>
                                                        ...
                                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                                            ...
                                                            <li>
                                                                ...
                                                                @if ($livraison->lignes_non_valides == $livraison->lignes_non_valides + $livraison->lignes_valides)
                                                                    ...
                                                                    <li>
                                                                        <form action="{{ route('bons-ventes.destroy', $livraison->id) }}"
