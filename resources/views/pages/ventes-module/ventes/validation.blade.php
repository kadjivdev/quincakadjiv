            ...
            <div class="col-lg-12 py-2">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-6">
                                <h5 class="card-title text-dark">Validation</h5>
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <form action="{{ route('vente-validate', $vente->id) }}"
                                ...
                                <div class="col-lg-12 d-flex flex-row align-items-center justify-content-between">
                                    <button type="submit" class="btn btn-sm btn-dark text_orange w-100 submitBtn" onclick="return confirm('Voulez vous vraiment valider cette vente? Cette opération est irréversible')"><i class="bi bi-check-circle"></i> Valider la vente</button>
