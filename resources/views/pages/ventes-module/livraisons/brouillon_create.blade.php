                    ...
                    if (data.articles.length > 0) {
                        ...
                        <tr>
                            ...
                            <td data-name="qte_cmde" contenteditable="true">
                                <input type="number" name="qte_cdes[]" max="${data.articles[i].qte_cmde}" value="${data.articles[i].qte_cmde}" class="form-control"></td>
                            <td data-name="prix_unit" contenteditable="true">
                            <input type="text" name="prixUnits[]" readonly value="${data.articles[i].prix_unit}" class="form-control">
                                </td>
