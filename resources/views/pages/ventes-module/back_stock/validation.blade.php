            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body py-2">
                        ...
                        <div class="row">
                            <div class="col-6">
                                <h5 class="card-title text-dark">Valider le retour de stock {{$back->reference}}</h5>
                            </div>
                        </div>
                        ...
                        <div>
                            @if (is_null($back->validate_at))
                                <form action="{{ route('back-validate', $back->id) }}"
                                    ...
                                    @csrf
                                    @method('GET')
                                    <button type="submit" class="btn btn-sm bg-dark text_orange" onclick="return confirm('Voulez vous vraiment valider ce retour de stock? Cette opération est irréversible')"><i class="bi bi-check-circle"></i> Valider le retour</button>
                                </form>
                            @endif
                        </div>
                    </div>
