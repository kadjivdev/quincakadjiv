...
@section('content')
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex">
            <div class="col-6">
                <h1 class="float-left">Factures clients </h1>
            </div>
        ...
        <section class="section">
            <div class="row col-12 mb-3">
                <form method="GET" action="{{ route('rap_fact_vte_clt') }}">
                    <div class="row mb-3">
                        <div class="col-5">
                                ...
                                <tbody>
                                    @forelse ($facturesTous as $facture)
                                        <tr>
                                            ...
                                            <td>{{ ($facture->client === null) ? $facture->client_facture : $facture->client->nom_client }}</td>
