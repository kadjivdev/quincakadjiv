<section class="section">
    ...
    <div class="row" style="text-align: center">
        ...
        <div class="col-4 flex-row justify-content-center">
            ...
            <h5 class="text-danger">{{ number_format($factureFrs->montant_facture, 2, ',', ' ') }}</h5>

        </div>

        <div class="col-4">
            <small class="text-dark" style="text-decoration: underline">Montants TTC</small>
            <h5 class="text-danger">{{ number_format($factureFrs->montant_total, 2, ',', ' ') }}</h5>
             </div>
    ...
    <div class="row">
        <div class="col-lg-12">
            <h5 class="card-title">Liste des articles de la facture </h5>
