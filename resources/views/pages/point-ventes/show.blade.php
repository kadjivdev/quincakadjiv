    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle d-flex">
            ...
            <div class="col-6 justify-content-end">
                <div class="">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#staticBackdropStock">
                        Importer stock
                    </button>
                    <a href="{{ route('boutiques.index')}}" class="btn btn-success float-end"> <i class="bi bi-arrow-left"></i>  Retour</a>
                </div>
            </div>
        </div>
