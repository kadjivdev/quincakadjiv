                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body py-2">
                            ...
                            @endif
                            <h5 class="card-title text-dark">Ajouter un chauffeur</h5>

                            <!-- Vertical Form -->
                            <form class="row g-3" action="{{ route('chauffeurs.store') }}" method="POST">
                                @csrf
                                <div class="col-12">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" value="{{ old('permis')}}" name="permis" id="permis">
                                </div>
